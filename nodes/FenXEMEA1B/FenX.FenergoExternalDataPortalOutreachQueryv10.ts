...
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaloutreachquery/api/association/root/{EntityId}/journey/{JourneyId}'.replace('{JourneyId}', JourneyId).replace('{EntityId}', EntityId);

break;
case 'GetAssociatedEntityComments': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaloutreachquery/api/association/existingassociatedentitycomments/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetDataByJourneyId': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaloutreachquery/api/data/getdatabyjourneyid/{journeyId}'.replace('{journeyId}', journeyId);

break;
case 'GetRelatedDataList': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaloutreachquery/api/related-data/getlist';

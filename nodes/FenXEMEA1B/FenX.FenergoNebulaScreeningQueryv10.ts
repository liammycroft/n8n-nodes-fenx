...
async function ExecuteFenergoNebulaScreeningQueryv10(base: IExecuteFunctions): Promise < INodeExecutionData[][] > {
    ...
    let id=''; let journeyId=''; let processId=''; let legalEntityId=''; let providerId=''; let entityId=''; let batchId=''; let matchId=''; let scopingRuleSetId=''; let versionNumber='';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/screeningquery/api/configuration';
requestOptions.qs = { config: base.getNodeParameter('config', 0) as string };
break;
case 'GetConfigurationLite': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/screeningquery/api/configuration/lite';

break;
case 'GetProvider': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/screeningquery/api/configuration/provider/{providerId}'.replace('{providerId}', providerId);
requestOptions.qs = { config: base.getNodeParameter('config', 0) as string };
break;

...
let FenergoNebulaExternalDataBFFv10Properties: INodeProperties[] = [
    {
        ...
        type: 'options',
        options: [
            { name: 'Create new search request', value: 'RequestSearch' },{ name: 'Create new search request for existing context', value: 'RequestNewRequestSearch' },{ name: 'Get process data by context type and id', value: 'GetNewRequest' },{ name: 'Create new search request', value: 'RequestProcessSearch' },{ name: 'Create new get request', value: 'RequestProcessGet' },{ name: 'Create Ultimate Beneficial Owner discovery request', value: 'RequestProcessUbo' },{ name: 'Create new import request', value: 'RequestNewRequestImport' },{ name: 'Create new import request', value: 'RequestProcessImport' },{ name: 'Create new document retrieval request', value: 'RequestProcessGetDocument' },{ name: 'Create new Reject/Reset documents status request', value: 'UpdateDocuments' },{ name: 'Get process data by context type and id', value: 'GetProcess' },{ name: 'Get process get data by id', value: 'GetProcessGet' }
        ],
        displayOptions: {
            show: {
                domain: [
...
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaldatabff/api/processes/{contextType}/search'.replace('{contextType}', contextType);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'RequestNewRequestSearch': contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaldatabff/api/processes/newRequest/{contextId}/search'.replace('{contextId}', contextId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetNewRequest': contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaldatabff/api/processes/newRequest/{contextId}'.replace('{contextId}', contextId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}/search'.replace('{contextType}', contextType).replace('{contextId}', contextId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'RequestProcessGet': contextType = base.getNodeParameter('contextType', 0) as string;
contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}/get'.replace('{contextType}', contextType).replace('{contextId}', contextId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'RequestProcessUbo': contextType = base.getNodeParameter('contextType', 0) as string;
contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}/ubo'.replace('{contextType}', contextType).replace('{contextId}', contextId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'RequestNewRequestImport': contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaldatabff/api/processes/newRequest/{contextId}/import'.replace('{contextId}', contextId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'RequestProcessImport': contextType = base.getNodeParameter('contextType', 0) as string;
contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}/import'.replace('{contextType}', contextType).replace('{contextId}', contextId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}/gets/{getId}/document'.replace('{contextType}', contextType).replace('{contextId}', contextId).replace('{getId}', getId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateDocuments': contextType = base.getNodeParameter('contextType', 0) as string;
contextId = base.getNodeParameter('contextId', 0) as string;
getId = base.getNodeParameter('getId', 0) as string;
...
contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}'.replace('{contextType}', contextType).replace('{contextId}', contextId);
...
getId = base.getNodeParameter('getId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}/gets/{getId}'.replace('{contextType}', contextType).replace('{contextId}', contextId).replace('{getId}', getId);

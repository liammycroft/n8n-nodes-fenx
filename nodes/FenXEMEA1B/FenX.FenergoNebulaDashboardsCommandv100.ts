...
requestOptions.uri = 'https://api.emea1b.fenergox.com/dashboardscommand/api/user-tasks';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'BulkSetIsFavouriteFlag': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/dashboardscommand/api/user-tasks/bulk';

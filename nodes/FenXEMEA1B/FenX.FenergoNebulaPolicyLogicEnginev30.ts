...
requestOptions.uri = 'https://api.emea1b.fenergox.com/policylogicengine/api/v3/cache/flush';
...
requestOptions.uri = 'https://api.emea1b.fenergox.com/policylogicengine/api/v3/engine/evaluate-requirement-sets';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EvaluateV3': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/policylogicengine/api/v3/engine/evaluate-requirements';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EvaluateRequirementsInScope': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/policylogicengine/api/v3/engine/evaluate-requirements-in-scope';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'EvaluateAllRequirements': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/policylogicengine/api/v3/engine/evaluate-all-requirements';

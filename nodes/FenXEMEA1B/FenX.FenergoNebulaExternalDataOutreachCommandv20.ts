...
let FenergoNebulaExternalDataOutreachCommandv20Properties: INodeProperties[] = [
    {
        ...
        type: 'options',
        options: [
            { name: 'Create new Entity Association', value: 'CreateAssociation' },{ name: 'Permanently delete an existing outreach Association', value: 'DeleteAssociation' },{ name: 'Update an existing outreach association', value: 'UpdateAssociation' },{ name: 'Stores comments of an existing associated entity', value: 'UpsertExistingAssociatedEntityComments' },{ name: 'Update outreach entity data', value: 'UpdateOutreachDataV2' },{ name: 'Update related outreach data', value: 'UpdateRelatedOutreachDataV2' },{ name: 'Create related outreach data', value: 'CreateRelatedOutreachData' },{ name: 'Permanently deletes existing outreach related data.', value: 'ClearOutreachRelatedData' }
        ],
        displayOptions: {
            show: {
                domain: [

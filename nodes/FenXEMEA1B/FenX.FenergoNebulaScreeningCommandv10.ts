...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.emea1b.fenergox.com/screeningcommand/api/configuration/{configurationId}/use-configuration-v2'.replace('{configurationId}', configurationId);

...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/screeningcommand/api/configuration';

break;
case 'AddProvider': configurationId = base.getNodeParameter('configurationId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/screeningcommand/api/configuration/{configurationId}/provider'.replace('{configurationId}', configurationId);
...
requestOptions.uri = 'https://api.emea1b.fenergox.com/screeningcommand/api/configuration/{configurationId}/provider/{providerId}'.replace('{configurationId}', configurationId).replace('{providerId}', providerId);

break;
case 'UpdateProvidersActiveStatus': configurationId = base.getNodeParameter('configurationId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.emea1b.fenergox.com/screeningcommand/api/configuration/{configurationId}'.replace('{configurationId}', configurationId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdateSecondaryIdentifiers': configurationId = base.getNodeParameter('configurationId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.emea1b.fenergox.com/screeningcommand/api/configuration/{configurationId}/secondaryidentifiers'.replace('{configurationId}', configurationId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'TestProvider': configurationId = base.getNodeParameter('configurationId', 0) as string;
providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.emea1b.fenergox.com/screeningcommand/api/configuration/{configurationId}/provider/{providerId}/test'.replace('{configurationId}', configurationId).replace('{providerId}', providerId);

...
let FenergoNebulaReportsCommandv20Properties: INodeProperties[] = [
    {
        ...
        type: 'options',
        options: [
            { name: 'Create a new Query definition', value: 'CreateSqlQueryDefinitionV2' },{ name: 'Update a Query definition', value: 'UpdateSqlQueryDefinitionV2' },{ name: 'Create report', value: 'CreateReportV2' },{ name: 'Creates AI driven report query based on User Input', value: 'CreateQueryStatement' },{ name: 'Triggers generation of AI driven charts based on report columns', value: 'CreateChartAsynchronous' },{ name: 'Generates a transaction rule based on user input, using an AI model', value: 'CreateRule' },{ name: 'Preview report', value: 'Preview' }
        ],
        displayOptions: {
            show: {
                domain: [

...
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportsquery/api/QueryDefinition';

break;
case 'GetQueryDefinitionById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportsquery/api/QueryDefinition/{id}'.replace('{id}', id);

break;
case 'GetReportById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportsquery/api/Report/{id}'.replace('{id}', id);

break;
case 'GetStatusById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportsquery/api/Report/{id}/status'.replace('{id}', id);

break;
case 'GetTables': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportsquery/api/Schema';

break;
case 'GetTable': tableName = base.getNodeParameter('tableName', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/reportsquery/api/Schema/{tableName}'.replace('{tableName}', tableName);

...
requestOptions.uri = 'https://api.emea1b.fenergox.com/outreachquery/api/EmailDomain';

break;
case 'GetEmailTamplatesByTenant': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/outreachquery/api/EmailTemplates';

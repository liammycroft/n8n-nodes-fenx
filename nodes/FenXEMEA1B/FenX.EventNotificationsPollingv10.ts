...
requestOptions.uri = 'https://api.emea1b.fenergox.com/eventnotifications/v1/{feedId}/next'.replace('{feedId}', feedId);
...
requestOptions.uri = 'https://api.emea1b.fenergox.com/eventnotifications/v1/{feedId}/{batchId}/complete'.replace('{feedId}', feedId).replace('{batchId}', batchId);

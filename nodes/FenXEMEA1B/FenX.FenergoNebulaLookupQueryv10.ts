...
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.emea1b.fenergox.com/lookupquery/api/lookuplink/{linkLookupId}/version/{versionNumber}/file'.replace('{linkLookupId}', linkLookupId).replace('{versionNumber}', versionNumber);

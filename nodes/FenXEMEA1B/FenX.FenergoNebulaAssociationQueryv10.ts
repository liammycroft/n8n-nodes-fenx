...
async function ExecuteFenergoNebulaAssociationQueryv10(base: IExecuteFunctions): Promise < INodeExecutionData[][] > {
    ...
    let entityId=''; let journeyId=''; let agentId=''; let sourceId=''; let id=''; let EntityId=''; let JourneyId=''; let productId=''; let collateralId=''; let assetId=''; let taskId=''; let sourceEntityId=''; let MaxLevel=''; let dealId='';

...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/dealscommand/api/deals/{id}/create-url-to-upload-file'.replace('{id}', id);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/dealscommand/api/deals/{id}/enable-editing'.replace('{id}', id);

...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/collateralquery/api/asset/collateral/{collateralId}/journey/{journeyId}/task/{taskId}'.replace('{collateralId}', collateralId).replace('{journeyId}', journeyId).replace('{taskId}', taskId);
...
taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.apac1.fenergox.com/collateralquery/api/collateral/journey/{journeyId}/task/{taskId}'.replace('{journeyId}', journeyId).replace('{taskId}', taskId);

...
requestOptions.uri = 'https://api.apac1.fenergox.com/policyproviderscommand/api/provider';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'UpdatePolicyProvider': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.apac1.fenergox.com/policyproviderscommand/api/provider/{providerId}'.replace('{providerId}', providerId);

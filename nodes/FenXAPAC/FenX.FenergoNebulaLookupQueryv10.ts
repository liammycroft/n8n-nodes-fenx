...
let FenergoNebulaLookupQueryv10Properties: INodeProperties[] = [
    {
        ...
        type: 'options',
        options: [
            { name: 'Gets all Lookups for the client tenant.', value: 'GetAllLookups' },{ name: 'Gets all Lookups active version for the client tenant.', value: 'GetAllActiveLookups' },{ name: 'Gets all Lookups (lite)', value: 'GetAllLookupsLite' },{ name: 'Get the active version of an existing Lookup by ID', value: 'GetLookupById' },{ name: 'Get a specific version of an existing Lookup', value: 'GetLookupVersionById' },{ name: 'Get the active version of an existing Lookup by Name', value: 'GetLookupByName' },{ name: 'Gets a list of lookups and versions', value: 'GetLookupsByIdsAndVersion' },{ name: 'Gets a list of lookups and their active version from a list of names', value: 'GetLookupsByNames' },{ name: 'Retrieves a specific lookup version as a CSV file.', value: 'GetLookupVersionFile' },{ name: 'Get all lookups and their parent child relationship.', value: 'GetAllLinkLookups' },{ name: 'Gets all Link Lookups active version for the client tenant.', value: 'GetAllActiveLinkLookups' },{ name: 'Gets all Link Lookups (lite)', value: 'GetAllLinkLookupsLite' },{ name: 'Get the current active version of an existing Link Lookup along with its relationships.', value: 'GetLinkLookupById' },{ name: 'Get the specified version of an existing Linked Lookup', value: 'GetLinkLookupVersionById' },{ name: 'Gets a list of link lookups and versions', value: 'GetLinkLookupsByIdsAndVersion' },{ name: 'Get all Linked Lookup version of a existing Lookup', value: 'GetLinkLookupByLookup' }
        ],
        displayOptions: {
            show: {
                domain: [

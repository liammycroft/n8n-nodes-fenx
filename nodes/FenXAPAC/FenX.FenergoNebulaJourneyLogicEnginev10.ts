...
requestOptions.uri = 'https://api.apac1.fenergox.com/journeylogicengine/api/cache/flush';

break;
case 'EvaluateJourneySchema': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.apac1.fenergox.com/journeylogicengine/api/engine/evaluate-journey-schema';

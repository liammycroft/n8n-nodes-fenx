...
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.apac1.fenergox.com/screeningcommand/api/configuration/{configurationId}/use-configuration-v2'.replace('{configurationId}', configurationId);

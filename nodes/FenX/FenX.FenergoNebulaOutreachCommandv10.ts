...
requestOptions.uri = 'https://api.fenergox.com/outreachcommand/api/EmailDomain';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'VerifyDomain': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/outreachcommand/api/EmailDomain/{id}/verify'.replace('{id}', id);

break;
case 'EnableDomain': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/outreachcommand/api/EmailDomain/{id}/enable'.replace('{id}', id);

break;
case 'DisableDomain': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'PUT';
requestOptions.uri = 'https://api.fenergox.com/outreachcommand/api/EmailDomain/{id}/disable'.replace('{id}', id);

break;
case 'DeleteDomain': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'DELETE';
requestOptions.uri = 'https://api.fenergox.com/outreachcommand/api/EmailDomain/{id}'.replace('{id}', id);

break;
case 'SendEmail': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/outreachcommand/api/EmailMessages';

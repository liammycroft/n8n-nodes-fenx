...
let FenergoNebulaPortalTenantQueryv40Properties: INodeProperties[] = [
    {
        ...
        type: 'options',
        options: [
            { name: 'Gets password reset ticket', value: 'GetPasswordResetTicket' },{ name: 'Gets Tenant"s Email Provider', value: 'GetEmailProvider' },{ name: 'Gets Portal Users', value: 'GetPortalUsers' },{ name: 'Gets Portal User details', value: 'GetPortalUserDetails' },{ name: 'Searches for Legal Entities List to be linked to a Portal User', value: 'SearchForLinkLeCandidates' }
        ],
        displayOptions: {
            show: {
                domain: [

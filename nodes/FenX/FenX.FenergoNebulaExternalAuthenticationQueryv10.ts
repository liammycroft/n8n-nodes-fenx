...
requestOptions.uri = 'https://api.fenergox.com/externalauthenticationquery/api/configuration/{configurationId}'.replace('{configurationId}', configurationId);

break;
case 'GetAllConfigurationsByTenant': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externalauthenticationquery/api/configuration/getAll';

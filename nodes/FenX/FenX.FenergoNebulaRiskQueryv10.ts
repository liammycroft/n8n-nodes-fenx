...
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-assessment';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetRiskAssessmentByTaskId': taskId = base.getNodeParameter('taskId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-assessment/{taskId}'.replace('{taskId}', taskId);

break;
case 'GetRiskAssessments': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-assessment/taskResults';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAllRiskCalculatorOptionModels': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-calculator-options';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-calculator-options/{id}'.replace('{id}', id);

break;
case 'GetAllRiskConfigurationModels': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-configuration';

break;
case 'GetRiskConfigurationModelById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-configuration/{id}'.replace('{id}', id);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-configuration/{id}/version/{versionNumber}'.replace('{id}', id).replace('{versionNumber}', versionNumber);

break;
case 'GetRiskConfigurationCollectionById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-configuration/configuration-collection/{id}'.replace('{id}', id);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-configuration/configuration-collection/{id}/configuration-item/{itemName}'.replace('{id}', id).replace('{itemName}', itemName);

break;
case 'GetAllRiskModels': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-model';

break;
case 'GetRiskModelById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-model/{id}'.replace('{id}', id);

break;
case 'GetRiskModelByVersionNumber': id = base.getNodeParameter('id', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/risk-model/{id}/version/{versionNumber}'.replace('{id}', id).replace('{versionNumber}', versionNumber);

break;
case 'GetAllScopingRuleSetsLite': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/scoping-rule-set';

break;
case 'GetCurrentScopingRuleSetVersionByRuleSetId': scopingRuleSetId = base.getNodeParameter('scopingRuleSetId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/scoping-rule-set/{scopingRuleSetId}'.replace('{scopingRuleSetId}', scopingRuleSetId);
...
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/scoping-rule-set/{scopingRuleSetId}/version/{versionNumber}'.replace('{scopingRuleSetId}', scopingRuleSetId).replace('{versionNumber}', versionNumber);

break;
case 'GetAllThresholdModels': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/threshold-model';

break;
case 'GetThresholdModelById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/threshold-model/{id}'.replace('{id}', id);

break;
case 'GetThresholdModelByVersionNumber': id = base.getNodeParameter('id', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/riskquery/api/threshold-model/{id}/version/{versionNumber}'.replace('{id}', id).replace('{versionNumber}', versionNumber);

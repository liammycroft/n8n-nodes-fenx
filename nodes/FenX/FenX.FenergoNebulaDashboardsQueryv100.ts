...
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/journey-dashboard';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetTeamJourneyDashboardLite': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/journey-dashboard/lite';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetTeamJourneyDashboardPreview': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/journey-dashboard/preview';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetTeamJourneys': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/journey-dashboard/journeys';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetEntityJourneys': entityId = base.getNodeParameter('entityId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/journey-dashboard/journeys/entity/{entityId}'.replace('{entityId}', entityId);

break;
case 'GetJourneyTasks': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/journey-dashboard/tasks/{journeyId}'.replace('{journeyId}', journeyId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'getJourneyMilestonesTasks': journeyId = base.getNodeParameter('journeyId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/journey-dashboard/journeyMilestonesTasks/{journeyId}'.replace('{journeyId}', journeyId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetJourneyStatsDashboard': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/journey-stats';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetUserTasksDashboard': userId = base.getNodeParameter('userId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/task-queue/{userId}'.replace('{userId}', userId);

break;
case 'GetFavouriteTasksDashboard': userId = base.getNodeParameter('userId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/task-queue/favourites/{userId}'.replace('{userId}', userId);

break;
case 'GetTeamTasksDashboard': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/team-tasks';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetUnassignedTasksDashboard': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/unassigned-task';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetUnassignedTasksDashboardPreview': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/unassigned-task/preview';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetUserUnassignedTasks': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/unassigned-task/tasks';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/dashboardsquery/api/user-journey-dashboard/{userId}'.replace('{userId}', userId);

...
requestOptions.uri = 'https://api.fenergox.com/reportscommand/api/Query';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'DeleteSqlQueryDefinition': Id = base.getNodeParameter('Id', 0) as string;
requestOptions.method = 'DELETE';
requestOptions.uri = 'https://api.fenergox.com/reportscommand/api/Query/{Id}'.replace('{Id}', Id);

break;
case 'CreateReport': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/reportscommand/api/Report';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'Preview': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/reportscommand/api/Report/Preview';

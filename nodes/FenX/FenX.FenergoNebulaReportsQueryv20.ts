...
requestOptions.uri = 'https://api.fenergox.com/reportsquery/api/v2/Query';

break;
case 'GetQueryById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/reportsquery/api/v2/Query/{id}'.replace('{id}', id);

break;
case 'GetReportingHistory': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/reportsquery/api/v2/Query/{id}/history'.replace('{id}', id);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAssistantHistory': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/reportsquery/api/v2/Query/{id}/assistant/history'.replace('{id}', id);

break;
case 'GetReportByIdV2': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/reportsquery/api/v2/Report/{id}'.replace('{id}', id);

break;
case 'GetStatusByIdV2': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/reportsquery/api/v2/Report/{id}/status'.replace('{id}', id);

break;
case 'GetReportResultV2': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/reportsquery/api/v2/Report/{id}/result/download'.replace('{id}', id);

break;
case 'GetTables': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/reportsquery/api/v2/Schema';

break;
case 'GetTable': tableName = base.getNodeParameter('tableName', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/reportsquery/api/v2/Schema/{tableName}'.replace('{tableName}', tableName);

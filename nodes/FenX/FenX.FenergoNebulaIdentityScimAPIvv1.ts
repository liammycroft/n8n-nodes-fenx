...
requestOptions.uri = 'https://api.fenergox.com/scim/Bulk';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAllResourceTypes': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/scim/ResourceTypes';

break;
case 'GetResourceTypeById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/scim/ResourceTypes/{id}'.replace('{id}', id);

break;
case 'GetAllSchemas': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/scim/Schemas';

break;
case 'GetSchemaById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/scim/Schemas/{id}'.replace('{id}', id);

break;
case 'GetServiceProviderConfig': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/scim/ServiceProviderConfig';

break;
case 'GetAllUsers': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/scim/Users';
...
case 'SearchUsers': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/scim/Users/.search';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetUserById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/scim/Users/{id}'.replace('{id}', id);

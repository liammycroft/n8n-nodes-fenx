...
requestOptions.uri = 'https://api.fenergox.com/bulkloadquery/api/jobs';
requestOptions.qs = { name: base.getNodeParameter('name', 0) as string };
break;
case 'GetAllActiveJobs': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/bulkloadquery/api/jobs/active';

break;
case 'GetJob': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/bulkloadquery/api/jobs/{id}'.replace('{id}', id);

break;
case 'GetInputTemplateSignedUrl': jobId = base.getNodeParameter('jobId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/bulkloadquery/api/jobs/{jobId}/input-template-signed-url'.replace('{jobId}', jobId);

break;
case 'GetErrorFileSignedUrl': jobId = base.getNodeParameter('jobId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/bulkloadquery/api/jobs/{jobId}/error-file-signed-url'.replace('{jobId}', jobId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/bulkloadquery/api/jobs/{jobId}/data-source-upload-signed-url/{type}'.replace('{jobId}', jobId).replace('{type}', type);

break;
case 'GetIngestionReportSignedUrl': jobId = base.getNodeParameter('jobId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/bulkloadquery/api/jobs/{jobId}/ingestion-report-signed-url'.replace('{jobId}', jobId);

break;
case 'GetIngestionReport': jobId = base.getNodeParameter('jobId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/bulkloadquery/api/jobs/{jobId}/ingestion-report'.replace('{jobId}', jobId);

break;
case 'GetUpserts': jobId = base.getNodeParameter('jobId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/bulkloadquery/api/jobs/{jobId}/upserts'.replace('{jobId}', jobId);

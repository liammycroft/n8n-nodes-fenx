...
requestOptions.uri = 'https://api.fenergox.com/covenantsconditionsquery/api/covenantcondition/set/{setId}'.replace('{setId}', setId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/covenantsconditionsquery/api/covenantcondition/data/parent/{parentId}/journey/{journeyId}/task/{taskId}'.replace('{parentId}', parentId).replace('{journeyId}', journeyId).replace('{taskId}', taskId);

break;
case 'GetCovenantConditionVersionById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/covenantsconditionsquery/api/covenantcondition/version/{id}'.replace('{id}', id);

break;
case 'GetCovenantConditionSetByParentId': parentId = base.getNodeParameter('parentId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/covenantsconditionsquery/api/covenantcondition/set/parent/{parentId}'.replace('{parentId}', parentId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/covenantsconditionsquery/api/covenantcondition/set/{setId}/version/{versionId}/snapshot'.replace('{setId}', setId).replace('{versionId}', versionId);

...
requestOptions.uri = 'https://api.fenergox.com/localisationquery/api/localisation';

break;
case 'GetAllActiveLocalisations': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/localisationquery/api/localisation/active';

break;
case 'GetDefaultLocalisation': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/localisationquery/api/localisation/default';

break;
case 'GetLocalisationById': localisationId = base.getNodeParameter('localisationId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/localisationquery/api/localisation/{localisationId}'.replace('{localisationId}', localisationId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/localisationquery/api/localisation/{localisationId}/version/{versionNumber}'.replace('{localisationId}', localisationId).replace('{versionNumber}', versionNumber);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/localisationquery/api/localisation/{localisationId}/version/{versionNumber}/context/{contextName}'.replace('{localisationId}', localisationId).replace('{versionNumber}', versionNumber).replace('{contextName}', contextName);
...
contextName = base.getNodeParameter('contextName', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/localisationquery/api/localisation/{localisationId}/version/{versionNumber}/context/{contextName}/signedUrl'.replace('{localisationId}', localisationId).replace('{versionNumber}', versionNumber).replace('{contextName}', contextName);

break;
case 'GetAllSystemLanguages': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/localisationquery/api/localisation/systemLanguages';

break;
case 'GetSystemLanguageByLanguageCode': languageCode = base.getNodeParameter('languageCode', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/localisationquery/api/localisation/systemLanguage/{languageCode}'.replace('{languageCode}', languageCode);

break;
case 'GetLanguageCode': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/localisationquery/api/lookup/languageCode';

break;
case 'GetUserPreference': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/localisationquery/api/userpreference';

...
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-instance/{journeyInstanceId}'.replace('{journeyInstanceId}', journeyInstanceId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-instance/{journeyInstanceId}/task/{taskId}'.replace('{journeyInstanceId}', journeyInstanceId).replace('{taskId}', taskId);

break;
case 'GetInstancesByEntityId': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-instance/search';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-instance/{journeyInstanceId}/linked-journeys'.replace('{journeyInstanceId}', journeyInstanceId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-instance/lifecycle-status/entity/{entityId}'.replace('{entityId}', entityId);

break;
case 'GetJourneyLaunchControlsById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-launch-controls/{id}'.replace('{id}', id);

break;
case 'GetJourneyLaunchControls': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-launch-controls';

break;
case 'GetAllJourneySchedules': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-schedule';

break;
case 'GetJourneyScheduleById': journeyScheduleId = base.getNodeParameter('journeyScheduleId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-schedule/{journeyScheduleId}'.replace('{journeyScheduleId}', journeyScheduleId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-schedule/{journeyScheduleId}/version/{versionNumber}'.replace('{journeyScheduleId}', journeyScheduleId).replace('{versionNumber}', versionNumber);

break;
case 'GetScheduleDatesByScheduleDate': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-schedule-date/search';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-schedule-date/{journeyScheduleDateId}'.replace('{journeyScheduleDateId}', journeyScheduleDateId);

break;
case 'GetAllJourneySchemasLite': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-schema/lite';

break;
case 'GetJourneySchemaById': journeySchemaId = base.getNodeParameter('journeySchemaId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-schema/{journeySchemaId}'.replace('{journeySchemaId}', journeySchemaId);

break;
case 'GetJourneySchemaVersionById': journeySchemaId = base.getNodeParameter('journeySchemaId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/journeyquery/api/journey-schema/{journeySchemaId}/version/{versionNumber}'.replace('{journeySchemaId}', journeySchemaId).replace('{versionNumber}', versionNumber);

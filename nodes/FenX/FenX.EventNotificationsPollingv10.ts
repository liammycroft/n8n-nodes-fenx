...
requestOptions.uri = 'https://api.fenergox.com/eventnotifications/v1/{feedId}/next'.replace('{feedId}', feedId);
...
requestOptions.uri = 'https://api.fenergox.com/eventnotifications/v1/{feedId}/{batchId}/complete'.replace('{feedId}', feedId).replace('{batchId}', batchId);

...
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookup';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookup/active';

break;
case 'GetAllLookupsLite': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookup/lite';
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookup/{lookupId}'.replace('{lookupId}', lookupId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookup/{lookupId}/version/{versionNumber}'.replace('{lookupId}', lookupId).replace('{versionNumber}', versionNumber);

break;
case 'GetLookupByName': lookupName = base.getNodeParameter('lookupName', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookup/name/{lookupName}'.replace('{lookupName}', lookupName);

break;
case 'GetLookupsByIdsAndVersion': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookup/versions';
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookup/names';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetLookupVersionFile': lookupId = base.getNodeParameter('lookupId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookup/{lookupId}/version/{versionNumber}/file'.replace('{lookupId}', lookupId).replace('{versionNumber}', versionNumber);

break;
case 'GetLookupByIdWithColumnFilter': lookupId = base.getNodeParameter('lookupId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookup/{lookupId}/column-filter'.replace('{lookupId}', lookupId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAllLinkLookups': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookuplink';

break;
case 'GetAllActiveLinkLookups': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookuplink/active';

break;
case 'GetAllLinkLookupsLite': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookuplink/lite';
requestOptions.qs = { includeNotes: base.getNodeParameter('includeNotes', 0) as string };
break;
case 'GetLinkLookupById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookuplink/{id}'.replace('{id}', id);

break;
case 'GetLinkLookupVersionById': id = base.getNodeParameter('id', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookuplink/{id}/version/{versionNumber}'.replace('{id}', id).replace('{versionNumber}', versionNumber);

break;
case 'GetLinkLookupsByIdsAndVersion': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookuplink/versions';
requestOptions.qs = { getActiveVersionIfNotFound: base.getNodeParameter('getActiveVersionIfNotFound', 0) as string };
requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetLinkLookupByLookup': lookupid = base.getNodeParameter('lookupid', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookuplink/lookup/{lookupid}'.replace('{lookupid}', lookupid);

break;
case 'GetLinkLookupVersionFile': linkLookupId = base.getNodeParameter('linkLookupId', 0) as string;
versionNumber = base.getNodeParameter('versionNumber', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/lookupquery/api/lookuplink/{linkLookupId}/version/{versionNumber}/file'.replace('{linkLookupId}', linkLookupId).replace('{versionNumber}', versionNumber);

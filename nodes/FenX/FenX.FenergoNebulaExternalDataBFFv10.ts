...
requestOptions.uri = 'https://api.fenergox.com/externaldatabff/api/processes/{contextType}/search'.replace('{contextType}', contextType);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'RequestNewRequestSearch': contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/externaldatabff/api/processes/newRequest/{contextId}/search'.replace('{contextId}', contextId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetNewRequest': contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldatabff/api/processes/newRequest/{contextId}'.replace('{contextId}', contextId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}/search'.replace('{contextType}', contextType).replace('{contextId}', contextId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'RequestProcessGet': contextType = base.getNodeParameter('contextType', 0) as string;
contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}/get'.replace('{contextType}', contextType).replace('{contextId}', contextId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'RequestProcessUbo': contextType = base.getNodeParameter('contextType', 0) as string;
contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}/ubo'.replace('{contextType}', contextType).replace('{contextId}', contextId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'RequestNewRequestImport': contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/externaldatabff/api/processes/newRequest/{contextId}/import'.replace('{contextId}', contextId);

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'RequestProcessImport': contextType = base.getNodeParameter('contextType', 0) as string;
contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}/import'.replace('{contextType}', contextType).replace('{contextId}', contextId);
...
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}/gets/{getId}/document'.replace('{contextType}', contextType).replace('{contextId}', contextId).replace('{getId}', getId);
...
contextId = base.getNodeParameter('contextId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}'.replace('{contextType}', contextType).replace('{contextId}', contextId);
...
getId = base.getNodeParameter('getId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.fenergox.com/externaldatabff/api/processes/{contextType}/{contextId}/gets/{getId}'.replace('{contextType}', contextType).replace('{contextId}', contextId).replace('{getId}', getId);

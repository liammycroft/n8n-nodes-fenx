...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningquery/api/configuration';
requestOptions.qs = { config: base.getNodeParameter('config', 0) as string };
break;
case 'GetConfigurationLite': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningquery/api/configuration/lite';

break;
case 'GetProvider': providerId = base.getNodeParameter('providerId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningquery/api/configuration/provider/{providerId}'.replace('{providerId}', providerId);
requestOptions.qs = { config: base.getNodeParameter('config', 0) as string };
break;

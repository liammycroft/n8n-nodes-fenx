...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningquery/api/batch/{batchId}/entity'.replace('{batchId}', batchId);
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningquery/api/batch/{batchId}/entity/{entityId}'.replace('{entityId}', entityId).replace('{batchId}', batchId);
requestOptions.qs = { returnMaterialMatches: base.getNodeParameter('returnMaterialMatches', 0) as string };
break;
...
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/screeningquery/api/ongoingscreening';

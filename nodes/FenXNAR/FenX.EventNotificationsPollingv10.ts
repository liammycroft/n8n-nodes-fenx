...
requestOptions.uri = 'https://api.nar1.fenergox.com/eventnotifications/v1/{feedId}/next'.replace('{feedId}', feedId);
...
requestOptions.uri = 'https://api.nar1.fenergox.com/eventnotifications/v1/{feedId}/{batchId}/complete'.replace('{feedId}', feedId).replace('{batchId}', batchId);

...
requestOptions.uri = 'https://api.nar1.fenergox.com/outreachquery/api/EmailDomain';

break;
case 'GetEmailTamplatesByTenant': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/outreachquery/api/EmailTemplates';

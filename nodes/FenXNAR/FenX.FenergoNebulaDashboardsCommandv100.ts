...
requestOptions.uri = 'https://api.nar1.fenergox.com/dashboardscommand/api/user-tasks';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'BulkSetIsFavouriteFlag': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/dashboardscommand/api/user-tasks/bulk';

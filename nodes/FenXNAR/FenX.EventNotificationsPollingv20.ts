...
requestOptions.uri = 'https://api.nar1.fenergox.com/eventnotifications/v2/{feedId}/discardAll'.replace('{feedId}', feedId);

break;
case 'GetNext': feedId = base.getNodeParameter('feedId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/eventnotifications/v2/{feedId}/next'.replace('{feedId}', feedId);

break;
case 'ListEventNotificationTypes': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/eventnotifications/v2/event-notification-types';
...
requestOptions.uri = 'https://api.nar1.fenergox.com/eventnotifications/v2/{feedId}/{batchId}/complete'.replace('{feedId}', feedId).replace('{batchId}', batchId);

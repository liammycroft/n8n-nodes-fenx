...
requestOptions.uri = 'https://api.nar1.fenergox.com/configexchangequery/api/configuration-exchange';

break;
case 'GetConfigurationEnvironmentById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/configexchangequery/api/configuration-exchange/{id}'.replace('{id}', id);

break;
case 'GetLatestImportedConfigsBySourceIds': 
requestOptions.method = 'POST';
requestOptions.uri = 'https://api.nar1.fenergox.com/configexchangequery/api/import-history/getLatestBySourceIds';

requestOptions.body = base.getNodeParameter('request', 0) as string; requestOptions.json = true;break;
case 'GetAllImportRecords': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/configexchangequery/api/import-history';

break;
case 'GetImportRecordById': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/configexchangequery/api/import-history/{id}'.replace('{id}', id);

break;
case 'GetImportSession': id = base.getNodeParameter('id', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/configexchangequery/api/import-session/{id}'.replace('{id}', id);

break;
case 'GetLogs': sessionId = base.getNodeParameter('sessionId', 0) as string;
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/configexchangequery/api/import-session/{sessionId}/log'.replace('{sessionId}', sessionId);

break;
case 'GetAllImportSessionSummaries': 
requestOptions.method = 'GET';
requestOptions.uri = 'https://api.nar1.fenergox.com/configexchangequery/api/import-session';

...
let FenergoNebulaExternalDataCommandv10Properties: INodeProperties[] = [
    {
        ...
        type: 'options',
        options: [
            { name: 'Save Provider status', value: 'SaveProviderStatusV2' },{ name: 'Save enabled entity type status', value: 'SaveEntityTypeStatus' },{ name: 'Save External Data Provider Configuration', value: 'SaveProviderConfigurationV2' },{ name: 'Add custom provider', value: 'AddCustomProviderV2' },{ name: 'Update custom provider', value: 'UpdateCustomProviderV2' },{ name: 'Create new document retrieval request', value: 'Createnewdocumentretrievalrequest' },{ name: 'Reject/Reset documents status', value: 'Reject/Resetdocumentsstatus' },{ name: 'Create new import request', value: 'Createnewimportrequest' },{ name: 'Save Associated Parties Deduplicate', value: 'SaveAssociatedPartiesDeduplicate' },{ name: 'Create or replace mapping', value: 'PutMapping' },{ name: 'Create or replace Operation Mapping', value: 'PutOperationMapping' },{ name: 'Unsubscribe from ongoing monitoring', value: 'UnsubscribeFromOngoingMonitoring' },{ name: 'Publish data to downstream system', value: 'Publishdatatodownstreamsystem' },{ name: 'Create new search request', value: 'Createnewsearchrequest' },{ name: 'Create Ultimate Beneficial Owner discovery request', value: 'CreateUltimateBeneficialOwnerdiscoveryrequest' }
        ],
        displayOptions: {
            show: {
                domain: [
